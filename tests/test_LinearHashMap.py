import pytest
from src.map.linear_hashmap import linear_hashmap

@pytest.fixture(name='empty_hashmap')
def fixture_empty_hashmap():
    """pytest fixture that generates an empty linear_hashmap object."""
    return linear_hashmap()

@pytest.fixture(name='sample_hashmap')
def fixture_sample_hashmap():
    """
    pytest fixture that generates a populated linear_hashmap object.
